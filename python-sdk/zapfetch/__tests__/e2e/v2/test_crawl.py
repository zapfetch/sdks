...
from zapfetch.v2.types import ScrapeOptions, PaginationConfig
...
class TestCrawlE2E:
    ...
    def setup_method(self):
        """Set up test client."""
        self.client = Zapfetch(api_key=os.getenv("API_KEY"), api_url=os.getenv("API_URL"))

    def test_start_crawl_minimal_request(self):
        """Test starting a crawl with minimal parameters."""
        crawl_job = self.client.start_crawl("https://docs.zapfetch.com", limit=3)
    ...
    def test_get_crawl_status(self):
        ...
        # First start a crawl
        start_job = self.client.start_crawl("https://docs.zapfetch.com", limit=3)
    ...
    def test_get_crawl_status_page(self):
        ...
        start_job = self.client.start_crawl("https://docs.zapfetch.com", limit=25)
        assert start_job.id is not None
    ...
    def test_get_active_crawls_with_running_crawl(self):
        ...
        # Start a crawl
        start_job = self.client.start_crawl("https://docs.zapfetch.com", limit=5)
        assert start_job.id is not None
