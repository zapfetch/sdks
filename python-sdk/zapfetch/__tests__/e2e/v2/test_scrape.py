...
import pytest
from zapfetch.v2.types import Viewport, ScreenshotAction, Document
...
class TestScrapeE2E:
    ...
    def test_scrape_minimal(self):
        ...
        doc = self.client.scrape("https://docs.zapfetch.com")
    ...
    def test_scrape_images_format(self):
        ...
        assert any("zapfetch" in img.lower() or "logo" in img.lower() for img in doc.images)
