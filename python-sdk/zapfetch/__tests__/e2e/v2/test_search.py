...
from zapfetch.types import SearchData, Document, ScrapeOptions, SearchResultWeb, SearchResultNews, SearchResultImages

load_dotenv()

zapfetch = Zapfetch(api_key=os.getenv("API_KEY"), api_url=os.getenv("API_URL"))
...
def _is_document(entry) -> bool:
    try:
        from zapfetch.v2.types import Document
...
def test_search_with_sources():
    ...
    assert 'zapfetch' in all_web_text
...
def test_search_all_parameters():
    ...
    from zapfetch.types import ScrapeOptions, JsonFormat, Location, WaitAction
    ...
    results = zapfetch.search(
        ...
        scrape_options=ScrapeOptions(
            ...
            headers={"User-Agent": "Zapfetch-Test/1.0"},
...
def test_search_formats_flexibility():
    ...
    from zapfetch.types import ScrapeFormats
    
    # Test with list format
    results1 = zapfetch.search(
