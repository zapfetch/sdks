import pytest
from zapfetch.v2.types import JsonFormat, ScrapeOptions, PDFParser
from zapfetch.v2.utils.validation import validate_scrape_options, prepare_scrape_options
...
class TestPrepareScrapeOptions:
    ...
    def test_prepare_new_v2_fields(self):
        ...
        from zapfetch.v2.types import Viewport, ScreenshotAction
