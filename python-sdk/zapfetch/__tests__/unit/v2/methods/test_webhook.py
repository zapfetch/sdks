"""
Unit tests for webhook functionality in Zapfetch v2 SDK.
"""

import pytest
from zapfetch.v2.types import WebhookConfig, CrawlRequest
from zapfetch.v2.methods.crawl import _prepare_crawl_request
