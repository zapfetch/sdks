...
from zapfetch.v2.methods.agent import _prepare_agent_request
from zapfetch.v2.types import AgentWebhookConfig
...
class TestAgentRequestPreparation:
    ...
    def test_basic_request_preparation(self):
        ...
        assert data["prompt"] == "Find information about Zapfetch"
