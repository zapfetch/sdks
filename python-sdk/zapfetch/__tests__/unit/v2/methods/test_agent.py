...
from zapfetch.v2.methods.agent import (
    start_agent,
    agent,
    get_agent_status,
    cancel_agent,
...
from zapfetch.v2.types import AgentResponse
from zapfetch.v2.utils.error_handler import BadRequestError
...
class TestAgentMethods:
    ...
    def test_start_agent_basic(self):
        ...
        result = start_agent(
            self.mock_client,
            None,
            prompt="Find information about Zapfetch"
        )
        ...
        body = call_args[0][1]
        assert body["prompt"] == "Find information about Zapfetch"
