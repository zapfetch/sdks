...
import unittest
import os
from zapfetch.v1.client import V1ZapfetchApp


class TestV1RecursiveRefDetection(unittest.TestCase):
    """Tests for _contains_recursive_ref method in V1ZapfetchApp."""
    
    def setUp(self):
        """Set up test client."""
        self.app = V1ZapfetchApp(api_key=os.environ.get('TEST_API_KEY', 'test-key'))
...
class TestV1CircularDefsDetection(unittest.TestCase):
    """Tests for _check_for_circular_defs method in V1ZapfetchApp."""
...
class TestV1ResolveRefs(unittest.TestCase):
    """Tests for _resolve_refs method in V1ZapfetchApp."""
...
class TestV1NormalizeSchemaForOpenAI(unittest.TestCase):
    """Tests for _normalize_schema_for_openai method in V1ZapfetchApp."""
...
class TestV1ValidateSchemaForOpenAI(unittest.TestCase):
    """Tests for _validate_schema_for_openai method in V1ZapfetchApp."""
...
class TestV1DetectRecursiveSchema(unittest.TestCase):
    """Tests for _detect_recursive_schema method in V1ZapfetchApp."""
...
class TestV1SelectModelForSchema(unittest.TestCase):
    """Tests for _select_model_for_schema method in V1ZapfetchApp."""
...
class TestV1ProcessSchemaWithValidation(unittest.TestCase):
    """Tests for _process_schema_with_validation method in V1ZapfetchApp."""
...
class TestV1EdgeCases(unittest.TestCase):
    """Tests for edge cases and error handling in V1ZapfetchApp."""
    ...
    def test_openai_schema_error_message_constant(self):
        ...
        self.assertIsNotNone(V1ZapfetchApp.OPENAI_SCHEMA_ERROR_MESSAGE)
        self.assertIn("invalid structure for OpenAI", V1ZapfetchApp.OPENAI_SCHEMA_ERROR_MESSAGE)
