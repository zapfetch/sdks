"""
Batch scraping functionality for Zapfetch v2 API.
"""
...
def start_batch_scrape(
    ...
    *,
    ...
    Raises:
        ZapfetchError: If the batch scrape operation fails to start
    """
...
def get_batch_scrape_status(
    ...
    Raises:
        ZapfetchError: If the status check fails
    """
    # Make the API request
...
def cancel_batch_scrape(
    ...
    Raises:
        ZapfetchError: If the cancellation fails
    """
    # Make the API request
...
def wait_for_batch_completion(
    ...
    Raises:
        ZapfetchError: If the job fails or timeout is reached
...
def batch_scrape(
    ...
    *,
    ...
    Raises:
        ZapfetchError: If the batch scrape fails to start or complete
        TimeoutError: If timeout is reached
    """
...
def process_large_batch(
    ...
    Raises:
        ZapfetchError: If any chunk fails
    """
