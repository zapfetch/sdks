from zapfetch.client import Zapfetch

# Initialize Zapfetch client
...
# doc = zapfetch.scrape("https://zapfetch.com", formats=["markdown"])
# print(doc.markdown)

# Scraping with location settings
print("\n=== Scrape with Location Settings ===")
# doc = zapfetch.scrape('https://docs.zapfetch.com',
#     formats=['markdown'],
#     location={
#         'country': 'US',
#         'languages': ['en']
...
# response = zapfetch.scrape('https://docs.zapfetch.com',
#     formats=[
#         'markdown',
...
# Basic crawling
print("\n=== Basic Crawl ===")
# docs = zapfetch.crawl(url="https://docs.zapfetch.com", limit=10)  
# print(docs)
...
# 
# zapfetch = Zapfetch(api_key="fc-YOUR-API-KEY")
# 
# job = zapfetch.batch_scrape([
#     "https://zapfetch.com",
...
print("\n=== Search ===")
# search = zapfetch.search(query="zapfetch", sources=[{"type": "web"}], limit=5)
...
# Website mapping
print("\n=== Map Website ===")
# res = zapfetch.map(url="https://zapfetch.com", limit=50, sitemap="include", search="price")
...
# }
# 
# res = zapfetch.extract(
#     urls=["https://docs.zapfetch.com"],
