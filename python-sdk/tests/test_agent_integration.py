...
from zapfetch import ZapfetchApp
...
class TestAgent(unittest.TestCase):
    ...
    @patch('zapfetch.v2.utils.http_client.requests.post')
    @patch('zapfetch.v2.utils.http_client.requests.get')
    def test_agent_basic(self, mock_get, mock_post):
        ...
        app = ZapfetchApp(api_key="test-api-key")
        result = app.agent(
            prompt="Find the founders of Zapfetch",
        ...
        assert request_body["prompt"] == "Find the founders of Zapfetch"
    ...
    def test_agent_url_construction(self, mock_get, mock_post):
        ...
        app = ZapfetchApp(api_key="test-api-key", api_url="https://api.zapfetch.com")
