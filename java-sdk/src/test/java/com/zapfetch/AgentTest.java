...
import com.zapfetch.models.AgentResponse;
 ...
 * 
 * Run with: ZAPFETCH_API_KEY=fc-xxx gradle test --tests "com.zapfetch.AgentTest"
 */
class AgentTest {
    ...
    void testAgentWithPrompt() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .prompt("Find information about Zapfetch's main features and pricing")
                        .build());
    ...
    void testAgentWithURLs() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .urls(List.of("https://zapfetch.com", "https://docs.zapfetch.com"))
                        .prompt("What are the main features of Zapfetch?")
                        .build());
    ...
    void testAgentWithSchema() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .urls(List.of("https://zapfetch.com"))
    ...
    void testStartAgent() {
        ...
        AgentResponse response = client.startAgent(
                AgentOptions.builder()
                        .prompt("Research Zapfetch features")
                        .build());
    ...
    void testAgentWithStrictURLConstraints() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .urls(List.of("https://docs.zapfetch.com"))
    ...
    void testAgentWithMaxCredits() {
        ...
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .prompt("Quick research on Zapfetch")
                        .maxCredits(10)
                        .build());
    ...
    void testAgentResearchTask() {
        System.out.println("\n=== Test: Agent Research - Zapfetch Features ===");
        
        AgentStatusResponse result = client.agent(
                AgentOptions.builder()
                        .urls(List.of("https://zapfetch.com", "https://docs.zapfetch.com"))
                        .prompt("Research and summarize the key features of Zapfetch, including scraping, crawling, and extraction capabilities")
                        .build());
