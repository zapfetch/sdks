 ...
 * 
 * Run with: ZAPFETCH_API_KEY=fc-xxx gradle test --tests "com.zapfetch.MapTest"
 */
class MapTest {
    ...
    void testMapMinimal() {
        ...
        MapData data = client.map("https://docs.zapfetch.com");
    ...
    void testMapWithSkipSitemap() {
        ...
        MapData data = client.map("https://zapfetch.com",
                MapOptions.builder()
                        .sitemap("skip")
                        .limit(15)
                        .build());
    ...
    void testMapWithIncludeSubdomains() {
        ...
        boolean hasSubdomains = data.getLinks().stream()
                .anyMatch(link -> {
                    String url = link.get("url") != null ? link.get("url").toString() : "";
                    return url.contains("docs.zapfetch.com") || 
                           url.contains("api.zapfetch.com") ||
                           (url.contains(".zapfetch.com") && !url.contains("zapfetch.com"));
                });
    ...
    @Test
    @EnabledIfEnvironmentVariable(named = "ZAPFETCH_API_KEY", matches = ".*\\S.*")
    void testMapZapfetchDocs() {
        System.out.println("\n=== Test: Map Zapfetch Documentation ===");
        ...
        System.out.println("✓ Mapped Zapfetch documentation");
        System.out.println("  Total links: " + data.getLinks().size());
