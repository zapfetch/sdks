 ...
 * 
 * Tests the scrape functionality of the Zapfetch Java SDK.
 * These tests require ZAPFETCH_API_KEY environment variable to be set.
 * 
 * Run with: ZAPFETCH_API_KEY=fc-xxx gradle test --tests "com.zapfetch.ScrapeTest"
 */
class ScrapeTest {
        ...
        assertThrows(ZapfetchException.class, () -> {
            client.scrape("not-a-valid-url",
                    ScrapeOptions.builder()
                            .formats(List.of("markdown"))
                            .build());
        }, "Should throw ZapfetchException for invalid URL");
