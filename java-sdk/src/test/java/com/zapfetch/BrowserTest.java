...
import com.zapfetch.models.BrowserCreateResponse;
import com.zapfetch.models.BrowserDeleteResponse;
import com.zapfetch.models.BrowserExecuteResponse;
import com.zapfetch.models.BrowserListResponse;
 ...
 *
 * Tests the browser session management functionality of the Zapfetch Java SDK.
 * These tests require ZAPFETCH_API_KEY environment variable to be set.
 *
 * Run with: ZAPFETCH_API_KEY=fc-xxx gradle test --tests "com.zapfetch.BrowserTest"
 */
class BrowserTest {
    ...
    void testBrowserExecuteRequiresSessionId() {
        ZapfetchClient testClient = ZapfetchClient.builder()
                .apiKey("fc-test-key")
                .build();
