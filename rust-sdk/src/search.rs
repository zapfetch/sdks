//! Search endpoint for ZapFetch API v2.
...
impl Client {
    ...
    ///
    /// ```no_run
    /// use zapfetch::{Client, SearchOptions, SearchSource};
    ///
    /// #[tokio::main]
    ...
    ///         match result {
    ///             zapfetch::SearchResultOrDocument::WebResult(r) => {
    ///                 println!("URL: {}", r.url);
    ///             }
    ///             zapfetch::SearchResultOrDocument::Document(d) => {
