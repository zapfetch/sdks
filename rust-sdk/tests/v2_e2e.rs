//! End-to-end tests for ZapFetch API.
//!
//! These tests require the following environment variables:
//! - API_URL: The ZapFetch API URL
...
async fn test_search_with_options() {
    ...
    let response = client
        .search("zapfetch web scraping", options)
        .await
...
fn test_client_creation() {
    ...
    let cloud_no_key = Client::new_selfhosted("https://api.zapfetch.com", None::<&str>);
