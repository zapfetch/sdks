...
async function run() {
  const apiKey = (globalThis.process && globalThis.process.env && globalThis.process.env.ZAPFETCH_API_KEY) || 'fc-YOUR_API_KEY';
...
const main = async () => {
  ...
  const extractResult = await app.extract(['https://zapfetch.com'], {
