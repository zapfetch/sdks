import ZapfetchApp from '../../../index';
import { describe, test, expect, jest, beforeEach, afterEach } from '@jest/globals';

describe.skip('monitorJobStatus retry logic [skipped: legacy test imports v2 default but calls v1 methods; pending rewrite against ZapfetchAppV1]', () => {
  let app: ZapfetchApp;
  let originalConsoleWarn: typeof console.warn;
  
  beforeEach(() => {
    app = new ZapfetchApp({ apiKey: 'test-key', apiUrl: 'https://test.com' });
