// Package option provides functional options for configuring the ZapFetch client.
package option
...
// WithAPIKey sets the API key. Defaults to the ZAPFETCH_API_KEY environment variable.
...
// WithAPIURL sets the API base URL. Defaults to https://api.zapfetch.com
// (overridable via the ZAPFETCH_API_URL environment variable).
